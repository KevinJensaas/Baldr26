...
*/    
    ...
    if (CarMovement.rotasjon != 0.0) {
        rotering = CarMovement.rotasjon;
    }

    /* Motor mixing */

    pMotorverdier->foran_venstre =
    y + x + rotering;

    pMotorverdier->foran_hoyre =
    y - x - rotering;

    pMotorverdier->bak_venstre =
    y - x + rotering;

    pMotorverdier->bak_hoyre =
    y + x - rotering;
